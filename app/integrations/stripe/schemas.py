# Stripe request/response schemas, translated from the API reference.
# Charge: https://docs.stripe.com/api/charges/object
# Refund: https://docs.stripe.com/api/refunds/object  (create: /api/refunds/create)
#
# Money is integer cents everywhere. extra="allow" keeps fields we don't model.
